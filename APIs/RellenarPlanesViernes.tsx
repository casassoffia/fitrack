...
const RellenarViernes = {


    rellenarViernesComida: async function () {
        const auth = getAuth()
        ...
        let arrayVacio2 = {}
        if ((usuario.semanaViernes < semanaCalculada) || (JSON.stringify(usuario.comidaViernes.desayuno) === JSON.stringify(arrayVacio2))) {
    ...
    rellenarViernesEjercicio: async function () {
        const auth = getAuth()
        const userLogued = auth.currentUser;
        ...
        if ((usuario.semanaViernes < semanaCalculada) || usuario.ejerciciosViernes == arrayvacio) {
                                                ...
                                                (num5) => {
                                                    ...
                                                    UserMethods.numeroAlteatorioEjercicio(numeros).then(
                                                        async (num6) => {
                                                            ...
                                                            const update = await updateDoc(usuarioref, {
                                                                semanaViernes: semanaCalculada,
                                                                ejerciciosViernes: numeros
...
export default RellenarViernes;
