...
const RellenarMiercoles = {


    rellenarMiercolesComida: async function () {
        const auth = getAuth()
        ...
        querySnapshot.forEach((doc) => {
            ...
            array = usuario.comidaMiercoles.desayuno
        })
        let arrayVacio2 = {}

        if (((usuario.semanaMiercoles < semanaCalculada) || (JSON.stringify(array) === JSON.stringify(arrayVacio2)))) {
    ...
    rellenarMiercolesEjercicio: async function () {
        const auth = getAuth()
        const userLogued = auth.currentUser;
                                                ...
                                                (num5) => {
                                                    ...
                                                    UserMethods.numeroAlteatorioEjercicio(numeros).then(
                                                        async (num6) => {
                                                            ...
                                                            const update = await updateDoc(usuarioref, {
                                                                semanaMiercoles: semanaCalculada,
                                                                ejerciciosMiercoles: numeros
...
export default RellenarMiercoles;
