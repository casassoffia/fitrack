...
const RellenarMartes = {


    rellenarMartesComida: async function () {
        const auth = getAuth()
        ...
        if ((usuario.semanaMartes < semanaCalculada || (JSON.stringify(usuario.comidaMartes.desayuno) === JSON.stringify(arrayVacio2)))) {
    ...
    rellenarMartesEjercicio: async function () {
        const auth = getAuth()
        const userLogued = auth.currentUser;
        ...
        if ((usuario.semanaMartes < semanaCalculada) || usuario.ejerciciosMartes == arrayvacio) {
                                                ...
                                                (num5) => {
                                                    ...
                                                    UserMethods.numeroAlteatorioEjercicio(numeros).then(
                                                        async (num6) => {
                                                            ...
                                                            const update = await updateDoc(usuarioref, {
                                                                semanaMartes: semanaCalculada,
                                                                ejerciciosMartes: numeros
